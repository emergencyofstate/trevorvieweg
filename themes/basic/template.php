 ...
 */
function basic_image_attach_attached_images_node($nid, $image_nodes, $img_size, $teaser = FALSE) {
...
//Removing username's blog link

function basic_links($links, $attributes = array()) {
